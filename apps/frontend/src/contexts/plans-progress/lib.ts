...
// ) => {
//   console.warn(
//     "[DEPRECATED] countTimesPerWeekPlanCompletedWeekSessions is deprecated. Use backend data from usePlanProgress instead."
//   );
...
// ) => {
//   console.warn(
//     "[DEPRECATED] getCompletedOn is deprecated. Use backend data from usePlanProgress instead."
//   );
...
// ) => {
//   console.warn(
//     "[DEPRECATED] isSessionCompleted is deprecated. Use backend data from usePlanProgress instead."
//   );
//   const weekStart = startOfWeek(session.date, { weekStartsOn: 0 });
//   const weekEnd = endOfWeek(session.date, { weekStartsOn: 0 });
...
// ) => {
//   console.warn(
//     "[DEPRECATED] isWeekCompleted is deprecated. Use backend data from usePlanProgress instead."
//   );
...
//   console.warn(
//     "[DEPRECATED] calculatePlanAchievement is deprecated. Use backend data from usePlanProgress instead."
//   );
...
// ): PlanWeek {
//   console.warn(
//     "[DEPRECATED] getPlanWeek is deprecated. Use backend data from usePlanProgress instead."
//   );
...
// ): PlanWeek[] {
//   console.warn(
//     "[DEPRECATED] getPlanWeeks is deprecated. Use backend data from usePlanProgress instead."
//   );
