...
//         {currentUser?.dailyCheckinDays != undefined && currentUser?.dailyCheckinTime != undefined ? (
//           <Card
//             emoji="☀️"
...
//                   <li>{formatList(currentUser.dailyCheckinDays)}</li>
//                   <li>In the {capitalize(currentUser.dailyCheckinTime)}</li>
//                 </ul>
//               </>
//             }
