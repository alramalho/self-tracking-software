...
async function main() {
  try {
    ...
    const outputPath = path.join(scriptDir, '..', '..', 'aws-infrastructure', 'allowed-routes.txt');
    ...
    console.log(`✅ Successfully wrote ${filteredRoutes.length} routes to ${outputPath}`);
    ...
    console.log('\n💡 Next steps:');
    console.log('   1. Review the generated routes in aws-infrastructure/allowed-routes.txt');
