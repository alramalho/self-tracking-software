...
export const Route = createFileRoute("/insights/onboarding")({
...
function OnboardingPage() {
  ...
  const handleSubmitAllRatings = async () => {
    ...
    logMetrics(
      Object.entries(ratings).map(([metricId, rating]) => ({
        metricId,
        rating,
        ...
        return (
          <>
            <div className="text-center space-y-4">
              ...
              <p className="text-md text-muted-foreground">
                Select up to {MAX_METRICS} metrics you&apos;d like to track and
              ...
              {defaultMetrics.map((metric) => (
                <Card
                  ...
                  className={`p-6 transition-all cursor-pointer ${
                    selectedMetrics.includes(metric.title)
                      ? "ring-2 ring-primary"
                      : ""
                  }`}
          ...
          <div className="space-y-8">
            <div className="space-y-8">
              {selectedMetrics.map((metricTitle, index) => {
                const metric = defaultMetrics.find(
                  (m) => m.title === metricTitle
                );
                ...
                return (
                  ...
                  >
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-md text-muted-foreground">
                        How would you rate your {metric.title.toLowerCase()}{" "}
                        today?
                      </p>
