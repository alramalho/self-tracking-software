...
export const MetricWeeklyView: React.FC<MetricWeeklyViewProps> = ({
  ...
  return (
    <div
      className={`my-2 bg-card/60 ring-1 ring-border rounded-3xl p-4 border border-card/50 ${className}`}
    >
      ...
      {hasAnyData ? (
        ...
        <div className="py-2 text-center">
          <p className="text-sm text-muted-foreground">No data this week yet.</p>
        </div>
      )}
