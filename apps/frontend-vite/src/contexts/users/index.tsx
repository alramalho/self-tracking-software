...
export const useUsers = (
  ...
  const query = useQuery({
    ...
    select: (data) => normalizeApiResponse<HydratedUser>(data, [
      ...
      "achievementPosts.createdAt",
      "achievementPosts.deletedAt",
      "achievementPosts.comments.createdAt",
      "achievementPosts.comments.deletedAt",
      "achievementPosts.reactions.createdAt",
    ]),
