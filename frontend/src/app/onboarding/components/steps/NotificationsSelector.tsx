...
export const NotificationsSelector = () => {
  ...
  async function handleRequestPermission() {
    ...
    if (result) {
      ...
      toast.error("Failed to set notifications permission. You might need to manually enable them in your phone settings.", {
        duration: 7000,
      });
    }
  }
          ...
          {!isSuccess && (
            ...
            >
              <p className="text-md text-gray-600">
                ...
                As our app relies on accountability and coaching, this is an important part of the onboarding.
              </p>
