    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden p-4 border border-gray-200">
      <div className="flex items-center mb-4">
        <Avatar
          ...
          className="mr-3 hover:cursor-pointer rounded-full w-20 h-20 flex items-center justify-center aspect-square"
        >
          <AvatarImage src={user?.picture} alt={user?.name} className="rounded-full w-full h-full" />
          <AvatarFallback className="rounded-full text-4xl">{user?.name?.[0]}</AvatarFallback>
        </Avatar>
