...
def generate_dummy_data():
    ...
    users = [
        ...
        User.new(id=str(ObjectId("666666666666666666666667")), name="E2E", email="alexandre.ramalho+e2etest@gmail.com", username="bamboozle", clerk_id="user_2oUKXciL3h0y3QFcNOqHM9GTwUp", friend_ids=["666666666666666666666665"]),
