...
class ExtractedPlanGuidelines(BaseModel):
    guidelines: str = Field(..., description="The guidelines for the plan")
...
plan_creation_simple_flowchart = {
    ...
    "ExtractPlanGuidelines": Node(
        ...
        output_schema=ExtractedPlanGuidelines,
