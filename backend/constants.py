...
AWS_ACCESS_KEY_ID=os.getenv("AWS_ACCESS_KEY_ID", os.getenv("OVERRIDE_AWS_ACCESS_KEY_ID"))
AWS_SECRET_ACCESS_KEY=os.getenv("AWS_SECRET_ACCESS_KEY", os.getenv("OVERRIDE_AWS_SECRET_ACCESS_KEY"))
