...
AWS_ACCESS_KEY_ID=os.getenv("AWS_ACCESS_KEY_ID", os.getenv("_AWS_ACCESS_KEY_ID"))
AWS_SECRET_ACCESS_KEY=os.getenv("AWS_SECRET_ACCESS_KEY", os.getenv("_AWS_SECRET_ACCESS_KEY"))
