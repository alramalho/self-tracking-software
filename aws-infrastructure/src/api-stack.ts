                    ...
                    arn: new wafv2.CfnRegexPatternSet(
                      ...
                      "ExploitScanningPatterns",
                      {
                        ...
                        regularExpressionList: [
                          ...
                          ".*(openapi|hello\\.world|containers|swagger|backend|api|env|\\.php|_profiler|.venv|info|wp-config|aws|server\\.key|composer\\.lock|dump\\.sh|server\\.info|docker|t4|actuator|/api/v1).*",
                        ],
                        description:
