...
TestFlight build 160 was built locally from the deployed `origin/main` commit `f74c2815`, validated by Apple, uploaded, processed and approved for internal and external beta testing on September 23, 2026. The private external group has only `alexandre.ramalho.1998@gmail.com`, its public link is disabled, and Apple's invitation request succeeded. The tester still needs to accept the invitation and install it. See `apps/frontend-expo/BUILDING.md` for the exact IPA and verification record.
